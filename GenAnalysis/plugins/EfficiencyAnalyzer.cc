...
/**\class EfficiencyAnalyzer EfficiencyAnalyzer.cc 
   GGAMuMuAnalysis/GenAnalysis/plugins/EfficiencyAnalyzer.cc

   Description: make numerator and denominator distributions as inputs to efficiency plots

   Implementation: this code makes the distributions and a ROOT macro divides them
*/
//
// Original Author:  Rachel Yohay,6 R-025,+41227672274,
//         Created:  Wed Nov 4 18:56:00 CEST 2015
// $Id: EfficiencyAnalyzer.cc,v 1.0 2015/11/04 18:56:00 yohay Exp $
//
//
